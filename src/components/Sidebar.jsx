...
export default function Sidebar() {
  ...
  const { user, logout } = useAuth(); // user has role
      ...
      >
        ...
        <div className="mb-6 flex flex-col items-center group">
          <div className="relative">
            ...
            <div className="relative w-20 h-20 rounded-full p-1 shadow-lg group-hover:scale-105 transition-transform duration-300">
              <div className="w-full h-full rounded-full bg-white dark:bg-gray-900 flex items-center justify-center overflow-hidden">
                <img src={logo} alt="Duka Logo" className="w-14 h-14 object-cover" />
              </div>
            </div>
          </div>
          <h1 className="mt-4 text-2xl font-bold text-green-500 tracking-wide">Duka</h1>
        ...
        <div className="mt-auto">
          ...
          <nav className="flex flex-col gap-2">{renderMenu(userMenu)}</nav>
